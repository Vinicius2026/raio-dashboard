...
import { getImagens, type Material } from "@/lib/material-apoio-data";
...
export default function ImagensMaterialPage() {
  const router = useRouter();
  const materials = getImagens();
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-5 md:px-6 py-4 sm:py-6 md:py-10">
          ...
          {materials.length === 0 && (
            <div className="text-center py-20">
              ...
              <p className="text-white/40">Nenhum material de imagem disponível no momento.</p>
            </div>
          )}
